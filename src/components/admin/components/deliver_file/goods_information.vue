  ...
  <div>
    ...
    <div class="from_body">
      ...
      <el-form label-position="top" label-width="80px" :model="formLabelAlign" :rules="rules" ref="ruleForm_g">
        ...
        <el-row :gutter="15">
          <!-- <el-col :span="5">
            <el-form-item label="产品数量（EQ）" prop="limited_number">
              <el-input v-model="formLabelAlign.limited_number" size="small"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="产品数量（P）" prop="non_danger_number">
              <el-input v-model="formLabelAlign.non_danger_number" size="small"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="产品数量（DG）" prop="danger_number">
              <el-input v-model="formLabelAlign.danger_number" size="small"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="申报货值" prop="declared_value">
              <el-input v-model="formLabelAlign.declared_value" size="small" style="width:55%;"></el-input>
              <el-select v-model="formLabelAlign.currency" placeholder="单位" style="width:40%;" size="small" clearable>
                <el-option
